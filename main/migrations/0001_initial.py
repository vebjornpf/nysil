    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('easy_question', models.TextField()),
                ('easy_answer', models.CharField(max_length=30)),
                ('easy_points', models.IntegerField(default=0)),
                ('medium_question', models.TextField()),
                ('medium_answer', models.CharField(max_length=30)),
                ('medium_points', models.IntegerField(default=0)),
                ('hard_question', models.TextField()),
                ('hard_answer', models.CharField(max_length=30)),
